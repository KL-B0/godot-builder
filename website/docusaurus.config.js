    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/KL-B0/godot-builder/edit/main/docs',
        },
        blog: false,
        theme: {
